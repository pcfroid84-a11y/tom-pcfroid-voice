  ...
  function sendGreetingResponse({ retry = false } = {}) {
    ...
    return sendToOpenAI({
      ...
      response: {
        ...
        instructions: `Output ONLY this exact text with zero additions or questions: "${state.greetingText}" Do not append any identity prompt, name question, or other text. Pronounce "P C Froid" as "pé cé froi" with the final D of "froid" silent. Never say "PC froide". Stop immediately after the greeting.`,
      },
    });
  }
